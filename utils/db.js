...
// 注：旧的 uniCloud 同步函数 (syncRecordToCloud / syncUpdateToCloud /
// syncDeleteFromCloud / pullFromCloud / isCloudAvailable / getCloudDb)
// 已在 commit 0b19d8a 后废弃，云端同步全部走 @/utils/api 的 REST 接口。
// 任何看到本注释的代码请直接删除。
